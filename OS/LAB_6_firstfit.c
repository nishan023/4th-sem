...
void firstFit(int blocks[], int originalBlocks[], int m, int processes[], int n)
{
    int allocation[n];
...
int main()
{
    ...
    // Execute the First Fit memory allocation algorithm
    firstFit(blocks, originalBlocks, m, processes, n);
    return 0;
}
